...
def plot_temperature(tmin=None, tmax=None, ymin=None, ymax=None, show_image=True, month="January", SAVEFIG=None):
    ...
    _set_plot_info(tmin, tmax, ymin, ymax, "Year", "Temperature [Celsius]", "Average tempature for %s per year" % month)
...
def plot_CO2_emissions_per_country(tmin=None, tmax=None, ymin=None, ymax=None, show_image=True,
                                   lower_threshold=None, upper_threshold=None, year=2013, SAVEFIG=None):
